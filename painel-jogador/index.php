        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                    ...
                    <div class="sidebar-brand-text mt-5 mb-2">
                        <img class="" src="<?php echo $foto_usu; ?>" width="100" style="border:3px solid #e74a3b;border-radius: 50px;">
                    </div>
                </a>
                <!-- RETIRADO OS DADOS DO USUARIO -->

                <!-- Divider -->
                <hr class="sidebar-divider my-0 bg-danger">



                <!-- Divider -->
                <hr class="sidebar-divider bg-danger">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="index.php?pag=<?php echo $menu1 ?>">
                        ...
                        <span class="">Depositar</span></a>
                </li>

                 <li class="nav-item">
                    <a class="nav-link" href="index.php?pag=<?php echo $menu2 ?>">
                        <i class="fas fa-minus-circle fa-chart-area"></i>
                        <span class="">Sacar</span></a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?pag=<?php echo $menu3 ?>">
                        <i class="fa fa-line-chart fa-chart-area"></i>
                        <span class="">Transações</span></a>
                </li>

                 <li class="nav-item">
                    <a class="nav-link" href="index.php?pag=<?php echo $menu4 ?>">
                        <i class="fas fa-history fa-chart-area"></i>
                        <span class="">Histórico</span></a>
                </li>
                ...
                <!-- Divider -->
                <hr class="sidebar-divider d-none d-md-block bg-danger">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
                        ...
                        <img class="" src="../img/snookerball-sf4.png" width="100" style="border-radius: 50px;">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="img-profile rounded-circle" src="<?php echo $foto_usu; ?>">
                ...
                <div class="modal-content bg-dark">
                    ...
                    <form id="form-perfil" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="btn-salvar-perfil" id="btn-salvar-perfil" class="btn btn-success">Salvar</button>
                        </div>
                    </form>
